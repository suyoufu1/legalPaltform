...
from app.algorithm.IdealWordCloudKit.keywords_tfidf import *
...
class CreateWordCloud:
    def __init__(self):
        ...
        self.background = os.path.join(cur, '')
    ...
    def show_cloud(self, word_dict, max_words, picturefile, save_name):
        ...
        plt.axis('off')
        plt.savefig("app/static/keyword/词云.jpg")
        # plt.show()
        # plt.close()
