...
function initEvents1545184311000(d) {
	...
	$m
			...
			.on(
					...
					function(e) {
						...
						window.location.href = "/down/moreDoc?docIds="+ ids.toString();
						return false;
					});
	// 收藏
	$m
	...
	$m
			...
			.on(
					...
					function(e) {
						var thisId = $(this).attr("data-value");
						window.location.href = "/down/oneDoc?docId="
								+ thisId;
						return false;
					});
	// 翻页
